                    ...
                    <div className="max-w-5xl mx-auto glass-card rounded-3xl md:rounded-[3rem] p-6 sm:p-8 md:p-16 grid lg:grid-cols-2 gap-10 md:gap-16">
                         <div>
                              ...
                              <div className="space-y-6">
                                   ...
                                   <div className="flex items-center gap-6 pt-4">
                                        ...
                                        <a className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/20 transition-all" href="www.github.com/aniruddh8877">
                         ...
                         <form className="space-y-6" data-purpose="contact-form" onSubmit={handleSubmit}>
                              <div className="space-y-2">
                                   ...
                                   <input className="w-full bg-white/5 border-white/10 rounded-2xl p-4 focus:ring-accent focus:border-accent transition-all text-white placeholder:text-gray-600" placeholder="Enter your name" type="text" />
                              </div>
                              <div className="space-y-2">
                                   <label className="text-sm font-bold uppercase tracking-widest text-gray-500">Email Address</label>
                                   <input className="w-full bg-white/5 border-white/10 rounded-2xl p-4 focus:ring-accent focus:border-accent transition-all text-white placeholder:text-gray-600" placeholder="Enter your email" type="email" />
                              </div>
                              <div className="space-y-2">
                                   <label className="text-sm font-bold uppercase tracking-widest text-gray-500">Message</label>
                                   <textarea className="w-full bg-white/5 border-white/10 rounded-2xl p-4 focus:ring-accent focus:border-accent transition-all text-white placeholder:text-gray-600" placeholder="Tell me about your project or idea" rows={4}></textarea>
                              </div>
