          ...
          <section className="py-24 px-6 overflow-hidden" id="projects">
               <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
                         <div>
                              <h2 className="text-5xl md:text-7xl font-heading font-extrabold">FEATURED</h2>
                              <h2 className="text-5xl md:text-7xl font-heading font-extrabold text-outline">PROJECTS</h2>
                         </div>
